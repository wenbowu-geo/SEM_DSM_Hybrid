!subroutine calculate_strain_elastic(RepInfo_Bound,nele_tele_coupling, &
...
!subroutine calculate_acoustic_strain(RepInfo_Bound,nele_tele_coupling,NGLOB_AB,potential_dot_dot_acoustic,&
...
use tele_coupling_par,only:DECIMATE_COUPLING,NSTEP_BETWEEN_OUTPUTBOUND,&
       traction_bound,disp_bound,nele_tele_coupling,coupling_ele_property,LOW_RESOLUTION,&
