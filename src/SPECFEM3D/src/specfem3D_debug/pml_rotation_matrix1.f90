subroutine pml_rotation_matrix (myrank)
...
pml_rotation_matrix_ximin=matmul(rotation_matrix0,rotation_matrix_xi_up)
pml_rotation_matrix_ximax=matmul(rotation_matrix0,rotation_matrix_xi_down)
pml_rotation_matrix_etamin=matmul(rotation_matrix0,rotation_matrix_eta_up)
pml_rotation_matrix_etamax=matmul(rotation_matrix0,rotation_matrix_eta_down)
...
!cubed sphere coordinates associated with this element itself
    ...
    if(CPML_regions(ispec)==CPML_X_ONLY.or.CPML_regions(ispec)==CPML_XZ_ONLY)
...
end subroutine pml_rotation_matrix
