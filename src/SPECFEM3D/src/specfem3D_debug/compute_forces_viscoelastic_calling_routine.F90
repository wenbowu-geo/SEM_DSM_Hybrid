...
!WENBO
  use tele_coupling_par, only:iele_strain_saved_ispec,strain_saved,save_strain,LOW_RESOLUTION,&
                          NSTEP_BETWEEN_OUTPUTBOUND,npoints_strain_saved,DECIMATE_COUPLING
...
! elastic term
    call compute_forces_viscoelastic(iphase,NSPEC_AB,NGLOB_AB, &
                        ...
                        phase_ispec_inner_elastic,.false.,iele_strain_saved_ispec,&
...
!WENBO
      ...
      if (STACEY_ABSORBING_CONDITIONS.and.(COUPLING_TYPE.eq.1.or.COUPLING_TYPE.eq.4)) then
      ...
      else if(COUPLING_TYPE.eq.2.or.COUPLING_TYPE.eq.3) then
        call compute_imposed_forces_elastic(NSPEC_AB,NGLOB_AB,SINGLE_FORCE_ENZ,accel, &
                        ibool,iphase, &
                        abs_boundary_normal,abs_boundary_jacobian2Dw, &
                        abs_boundary_ijk,abs_boundary_ispec, &
                        ...
                        b_absorb_field,xstore,ystore,zstore)
      endif
!WENBO
    ...
    !! CD CD
      ...
      if(COUPLING_TYPE.eq.1.or.COUPLING_TYPE.eq.4) then
...
! elastic term
    ...
    call compute_forces_viscoelastic(iphase,NSPEC_AB,NGLOB_AB, &
                        ...
                        ispec2D_moho_top,ispec2D_moho_bot, &
                        num_phase_ispec_elastic,nspec_inner_elastic,nspec_outer_elastic, &
                        phase_ispec_inner_elastic,.true.,iele_strain_saved_ispec,&
                        strain_saved,save_strain,LOW_RESOLUTION,NSTEP_BETWEEN_OUTPUTBOUND,&
                        npoints_strain_saved,COUPLING_TYPE,SINGLE_FORCE_ENZ,it,DECIMATE_COUPLING)
