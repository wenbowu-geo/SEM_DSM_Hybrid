...
specfem3D_OBJECTS = \
	...
	$O/read_EleBound.spec.o \
	$O/read_TelePara.spec.o \
	$O/euler_angles.spec.o \
	$O/set_Variables_Bound.spec.o \
	$O/get_Telecoupling_info.spec.o \
	$O/disp_stress_bound.spec.o \
	$O/compute_forces_imposed_acoustic.spec.o \
	$O/compute_forces_imposed_elastic.spec.o \
	$O/impose_boundary_condditions.spec.o \
	$O/save_bound_disp_traction.spec.o \
...
#WENBO_S
##DSM_coupling
$O/SEMtoTeleseis.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/read_EleBound.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/read_TelePara.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/set_Variables_Bound.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/get_Telecoupling_info.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/disp_stress_bound.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/save_bound_disp_traction.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
