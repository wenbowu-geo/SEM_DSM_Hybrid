...
!  Wenbo Wu modified this subroutine
!======================================================================================
...
! the code.  ANGULAR_WIDTH_ETA_IN_DEGREES and ANGULAR_WIDTH_XI_IN_DEGREES 
! are not used now, that occationally causes error 
! reports. But they might be usful in the future, so we keep them here.
  real_tmp=ANGULAR_WIDTH_ETA_IN_DEGREES
  real_tmp=ANGULAR_WIDTH_XI_IN_DEGREES
  ...
  do i = 1,NDIM
     ...
     enddo
  enddo
! z coordinate is the radius rather than the real z in cubed sphere coordinate
! system!
...
! Make y_cubedsph and x_cubedsph in unit of deg, rather than rad. Because it is
! deg in the subrountine pml_set_local_dampingcoeff.f90, 
