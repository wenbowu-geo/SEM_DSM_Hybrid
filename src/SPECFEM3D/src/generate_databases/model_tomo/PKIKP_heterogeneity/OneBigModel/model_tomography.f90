...
!***********************find the perturbation***********************
  ...
  double precision, parameter ::top_taper_depth_start =  15000.0
  double precision, parameter ::top_taper_depth_end =    15000.0
  !bottom tapering. Taper starts at 70 km and ends at 80 km below the ICB.
  double precision, parameter ::bot_taper_depth_start = 95000.0
  double precision, parameter ::bot_taper_depth_end =   105000.0
  !tapering at edges. Taper width and homogeneous-region width, in unit of
  !degree.
  double precision, parameter ::taper_width_edges = 0.5
  double precision, parameter ::dsm_width_edges = 0.25
