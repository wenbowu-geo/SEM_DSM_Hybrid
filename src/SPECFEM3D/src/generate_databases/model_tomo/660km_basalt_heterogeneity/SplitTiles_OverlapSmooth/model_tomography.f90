...
!***********************find the perturbation***********************
  ...
  !top tapering, in unit of km. 50 km below the top boundary, which is the 660-km.
  double precision, parameter ::top_taper_depth_start =  49999.0
  double precision, parameter ::top_taper_depth_end =    50000.0
  !top tapering, in unit of km. Use this linear tapering to represent the reduced
  !basalts from 660-km to 750-km.
