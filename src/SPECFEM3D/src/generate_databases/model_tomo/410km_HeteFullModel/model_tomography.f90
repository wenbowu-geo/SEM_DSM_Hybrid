...
!
  ...
  call read_full_model_tomography(myrank)
...
subroutine read_full_model_tomography(myrank)
  ...
  ix_max=NX_f; ix_min=1
  iy_max=NY_f; iy_min=1
  iz_max=NZ_f; iz_min=1
  ! ---------- Define NEW cropped model domain ----------
  NX = ix_max - ix_min + 1
  NY = iy_max - iy_min + 1
  NZ = iz_max - iz_min + 1
...
end subroutine read_full_model_tomography
...
!***********************find the perturbation***********************
  ...
  double precision, parameter ::bot_taper_depth_end =   10000000.0
