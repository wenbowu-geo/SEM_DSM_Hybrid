...
DOUBLE PRECISION, PARAMETER ::large_scatter_thickness = 10000.0 !unit of meter
DOUBLE PRECISION, PARAMETER ::depth_scatter_bot =     1000000.0 !unit of meter
DOUBLE PRECISION, PARAMETER ::large_scatter_width_x = 1.5
DOUBLE PRECISION, PARAMETER ::large_scatter_width_y = 1.5
DOUBLE PRECISION, PARAMETER ::large_scatter_x0 = 0.0
DOUBLE PRECISION, PARAMETER ::large_scatter_y0 = 0.0
DOUBLE PRECISION, PARAMETER ::degtorad=PI/180.0
DOUBLE PRECISION, PARAMETER ::dvp_vp = -0.015 
DOUBLE PRECISION, PARAMETER ::dvs_vs = -0.03
DOUBLE PRECISION, PARAMETER ::drho_rho = 0.05

radius = DSQRT(x_eval**2 + y_eval**2 + z_eval**2)
if(vs_final.gt.TINYVAL.and.abs(radius-(6371000.0-depth_scatter_bot))<large_scatter_thickness.and. &
   abs(xeval_cubedsph).lt.large_scatter_width_x*degtorad/2.0.and. &
   abs(yeval_cubedsph).lt.large_scatter_width_y*degtorad/2.0) then
