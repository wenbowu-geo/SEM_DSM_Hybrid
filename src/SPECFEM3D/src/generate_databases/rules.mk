...
generate_databases_OBJECTS = \
	...
	$O/save_depth_id.gen.o \
	$O/save_depth_id_inner.gen.o \
	$O/read_coupling_element.gen.o \
	$O/get_tele_coupling_surfaces.gen.o \
	$O/set_tele_coupling_variables.gen.o \
	$O/read_parameter_coupling.gen.o \
	$O/xyz_backto_cubedsph.gen.o \
	$O/euler_angles_back_cubedsph.gen.o \
	$O/tele_coupling_par.gen.o \
	$O/teleseismic_coupling.gen.o \
...
#WENBO_S
generate_databases_SHARED_OBJECTS += $(COND_MPI_OBJECTS)
#WENBO_E
...
#WENBO_S
mpi_generate_databases_OBJECTS += $O/save_package_list_nompi.gen.o
else
mpi_generate_databases_OBJECTS= \
	$O/model_sep.mpi_gen.o
#WENBO_S
mpi_generate_databases_OBJECTS += $O/save_package_list.mpi_gen.o
#WENBO_E
endif
...
#WENBO_S
$O/save_package_list.gen.o: $O/tele_coupling_par.gen.o
$O/save_depth_id.gen.o: $O/model_tomography.gen.o
$O/save_depth_id_inner.gen.o: $O/model_tomography.gen.o $O/tele_coupling_par.gen.o
$O/get_tele_coupling_surfaces.gen.o: $O/tele_coupling_par.gen.o $O/generate_databases_par.gen.o
$O/set_tele_coupling_variables.gen.o: $O/tele_coupling_par.gen.o
#$O/save_package_list.gen.o: $O/tele_coupling_par.gen.o
$O/read_coupling_element.gen.o: $O/tele_coupling_par.gen.o
$O/read_parameter_coupling.gen.o : $O/tele_coupling_par.gen.o
$O/teleseismic_coupling.gen.o: $O/tele_coupling_par.gen.o
#WENBO_E
$O/create_regions_mesh.gen.o: $O/generate_databases_par.gen.o $O/fault_generate_databases.gen.o
$O/model_tomography.gen.o: $O/generate_databases_par.gen.o $O/tele_coupling_par.gen.o
...
#WENBO_S
$O/%.gen.o: $S/%.f $O/shared_par.shared_module.o
