...
specfem3D_OBJECTS = \
	...
	$O/tele_coupling_par.spec.o \
	$O/read_coupling_element.spec.o \
	$O/read_parameter_coupling.spec.o \
	$O/euler_angles.spec.o \
	$O/set_tele_coupling_variables.spec.o \
	$O/get_tele_coupling_surfaces.spec.o \
	$O/disp_stress_coupling.spec.o \
	$O/compute_forces_imposed_acoustic.spec.o \
	$O/compute_forces_imposed_elastic.spec.o \
	$O/impose_boundary_condditions.spec.o \
	$O/save_coupling_disp_traction.spec.o \
	$O/save_parameter_coupling.spec.o \
	$O/locate_receivers_cubed.spec.o \
	$O/locate_source_cubed.spec.o \
	$O/xyz_backto_cubedsph.spec.o \
	$O/compute_pml_rotation_matrix.spec.o \
	$O/teleseismic_coupling.spec.o \
...
specfem3D_SHARED_OBJECTS += $O/get_shape2D.shared.o
...
#WENBO_S
$O/pml_compute_accel_contribution.spec.o: $O/pml_par.spec.o $O/tele_coupling_par.spec.o
$O/pml_compute_memory_variables.spec.o: $O/pml_par.spec.o  $O/tele_coupling_par.spec.o
#WENBO_E
...
#WENBO_S
##DSM_coupling
$O/teleseismic_coupling.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/read_coupling_element.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/read_parameter_coupling.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/set_tele_coupling_variables.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/get_tele_coupling_surfaces.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/disp_stress_coupling.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/save_coupling_disp_traction.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/save_parameter_coupling.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/compute_forces_imposed_acoustic.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/compute_forces_imposed_elastic.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/impose_boundary_condditions.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
$O/compute_forces_viscoelastic_calling_routine.spec.o : $O/tele_coupling_par.spec.o $O/specfem3D_par.spec_module.o
