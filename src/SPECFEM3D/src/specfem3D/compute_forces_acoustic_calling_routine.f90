...
!WENBO
  if(COUPLING_TYPE.eq.1.or.COUPLING_TYPE.eq.2.or.COUPLING_TYPE.eq.4) then
...
!WENBO
      ...
      else if(STACEY_ABSORBING_CONDITIONS.and.(COUPLING_TYPE.eq.2.or.COUPLING_TYPE.eq.3)) then
        call compute_imposed_forces_acoustic(NSPEC_AB,NGLOB_AB,SINGLE_FORCE_ENZ, &
                            potential_dot_dot_acoustic,potential_dot_acoustic, &
