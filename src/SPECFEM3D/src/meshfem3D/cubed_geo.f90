...
!  WENBO WU modfied this subroutine
!======================================================================================
subroutine cubed_geo(xelm,yelm,zelm,R_TOP_BOUND,ANGULAR_WIDTH_XI_IN_DEGREES, &
...
!  include "constants.h"
  ...
  double precision ANGULAR_WIDTH_XI_IN_DEGREES,ANGULAR_WIDTH_ETA_IN_DEGREES,R_TOP_BOUND
