...
meshfem3D_OBJECTS = \
	...
	$O/coupling_mesh_par.mesh.o \
	$O/cubed_geo.mesh.o \
	$O/find_coupling_elements.mesh.o \
	$O/compute_parameter_coupling.mesh.o \
	$O/save_coupling_element.mesh.o \
	$O/read_parameter_coupling.mesh.o \
	$O/euler_angles.mesh.o \
	$O/determine_ocean_land.mesh.o \
	...
	$O/get_flags_boundaries_cubed.mesh.o \
...
$O/read_parameter_coupling.mesh.o: $O/coupling_mesh_par.mesh.o $O/meshfem3D_par.mesh.o
$O/meshfem3D.mesh.o: $O/meshfem3D_par.mesh.o
$O/create_meshfem_mesh.mesh.o: $O/meshfem3D_par.mesh.o $O/coupling_mesh_par.mesh.o
