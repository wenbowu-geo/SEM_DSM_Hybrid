...
!WENBO_S
  use coupling_mesh_par, only: ANGULAR_WIDTH_XI_IN_DEGREES,ANGULAR_WIDTH_ETA_IN_DEGREES
!WENBO_E
...
!WENBO_S
!For DSM-SEM coupling, LONGITUDE_MIN,LATITUDE_MIN, LONGITUDE_MAX and LATITUDE_MAX are not 
!functional. Instead, we use ANGULAR_WIDTH_XI_IN_DEGREES,ANGULAR_WIDTH_ETA_IN_DEGREES to define 
!the model dimension. xi_min and eta_min are constant of 0.0.
