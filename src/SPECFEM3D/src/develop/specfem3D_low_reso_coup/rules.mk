...
#WENBO_S
$O/pml_compute_accel_contribution.spec.o: $O/pml_par.spec.o $O/SEMtoTele_par.spec.o
$O/pml_compute_memory_variables.spec.o: $O/pml_par.spec.o  $O/SEMtoTele_par.spec.o
#WENBO_E
...
#WENBO_S
##DSM_coupling
$O/SEMtoTeleseis.spec.o : $O/SEMtoTele_par.spec.o $O/specfem3D_par.spec_module.o
$O/read_EleBound.spec.o : $O/SEMtoTele_par.spec.o $O/specfem3D_par.spec_module.o
$O/read_TelePara.spec.o : $O/SEMtoTele_par.spec.o $O/specfem3D_par.spec_module.o
$O/set_Variables_Bound.spec.o : $O/SEMtoTele_par.spec.o $O/specfem3D_par.spec_module.o
$O/get_Telecoupling_info.spec.o : $O/SEMtoTele_par.spec.o $O/specfem3D_par.spec_module.o
$O/disp_stress_bound.spec.o : $O/SEMtoTele_par.spec.o $O/specfem3D_par.spec_module.o
$O/save_bound_disp_traction.spec.o : $O/SEMtoTele_par.spec.o $O/specfem3D_par.spec_module.o
$O/compute_forces_imposed_acoustic.spec.o : $O/SEMtoTele_par.spec.o $O/specfem3D_par.spec_module.o
$O/compute_forces_imposed_elastic.spec.o : $O/SEMtoTele_par.spec.o $O/specfem3D_par.spec_module.o
$O/impose_boundary_condditions.spec.o : $O/SEMtoTele_par.spec.o $O/specfem3D_par.spec_module.o
$O/compute_forces_viscoelastic_calling_routine.spec.o : $O/SEMtoTele_par.spec.o $O/specfem3D_par.spec_module.o
