...
!For example, an explosion source injection only needs three diagonal components; Vertical
!component simulation in a single-force mode only needs the results of vertical force 
!'Fz'; East or North component simulation only needs results of two forces 'Fr' and 'Ft'.
