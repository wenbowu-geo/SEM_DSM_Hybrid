...
!WENBO_S
 use SEMtoTele_par,only :xstore_dummy_cubedsph,ystore_dummy_cubedsph,zstore_dummy_cubedsph,&
...
! 1-D DSM model.
          ...
          if(CUBED_SPHERE_PROJECTION) then
            ...
            !xmesh_cubedsph,ymesh_cubedsph and zmesh_cubedsph.
              ...
              !to be removed
              !if(myrank.eq.81) print *,"xyztocubed",xmesh,ymesh,zmesh,&
              !      rotation_matrix_back_cubedsph
            end if
...
!WENBO_S
!Comment the below line. If you want to read external tomography model
!"tomography_model.xyz", just uncomment the below line.
...
!WENBO_E
  ...
  iflag_aniso = 0
!WENBO_S
!  equal idomain_id to imaterial_id, which is defined in Mesh_Par_file.
!That means imaterial_id=1 is acoustic and imaterial_id=2 is elastic
...
!to be fixed
     call model_tomography(imaterial_id,xmesh,ymesh,zmesh,xmesh_cubedsph,&
                                  ymesh_cubedsph,zmesh_cubedsph,r_middle, &
                                  rho,vp,vs,qkappa_atten,qmu_atten,myrank)
!     call model_ningxia(xmesh,ymesh,zmesh,r_middle, &
