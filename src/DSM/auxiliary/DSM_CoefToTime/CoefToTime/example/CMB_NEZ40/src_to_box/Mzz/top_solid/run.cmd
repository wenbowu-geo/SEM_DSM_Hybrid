...
mkdir OUTPUT_FILES/solid_velo OUTPUT_FILES/stress

#copy the resaved DSM coefficients
cp ../../../../../../Resave_Coef/example/CMB_NEZ40/src_to_box/Mzz/OUTPUT/dep_top/order_* DATA/

#copy the elastic modulus coefficient, used to calculate stress.
#'matetop_forSpecCoefToTime' was written by lines 476-490 in DSM/src/savespec.f and now these lines are not executed. Just turn on the option (change the parameter output_more in savespec.f to .true.) to write out this file.
...
echo "   3532000.00000000
   1024409844000.00
   1024409844000.00
   444085002000.000
   290162421000.000
   290162421000.000" > DATA/material_properties 
...
#!!!!!!!!!!!
#!!!!!!!!!!!
#I just know that the lines 2654-2686 of DATA/dist_from_SPECFEM3D are the distances at the last depth.
#If the model is changed, you have to accordingly modifiy the below line to get the correct distance table!!!!!!!!.
awk '{if(NR>1&&NR<=215) print $0;}'  DATA/dist_from_SPECFEM3D > DATA/ndist_file

#copy Partop_forSpecCoefToTime to Par_file and reedit it.
...
#file 'Partop_forSpecCoefToTime' was written by lines 452-474 in DSM/src/savespec.f and now these lines are not executed.
#cp ../../../../../../../../DSM//example/CMB_NEZ40/src_to_box/Mzz/OUTPUT_FILES/Partop_forSpecCoefToTime DATA/
