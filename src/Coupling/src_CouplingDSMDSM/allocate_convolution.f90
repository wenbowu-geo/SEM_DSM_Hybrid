...
use convolution_par
use coupling_SEM_DSM_par,only:npoints,myrank,nfit_dep,nfit_dist,disp_elas_DSM,&
       ...
       nfreq_DSM_toSrc,nloc_elas_DSM_toSrc,nloc_acous_DSM_toSrc
use constants
...
allocate(disp_elas_DSM_toSrc(nloc_elas_DSM_toSrc,ncomp))
allocate(stress_DSM_toSrc(nloc_elas_DSM_toSrc,ncomp_stress))
allocate(disp_acous_DSM_toSrc(nloc_acous_DSM_toSrc,ncomp))
allocate(pressure_DSM_toSrc(nloc_acous_DSM_toSrc))

allocate(rot_matrix_bound_toSrc(ncomp,ncomp,npoints))

allocate(distance(npoints,nstation))
allocate(distance_toSrc(npoints))
allocate(first_idep_fit_DSM(npoints,nstation))
allocate(first_idep_fit_DSM_toSrc(npoints))
allocate(first_idist_fit_DSM(npoints,nstation))
allocate(first_idist_fit_DSM_toSrc(npoints))
