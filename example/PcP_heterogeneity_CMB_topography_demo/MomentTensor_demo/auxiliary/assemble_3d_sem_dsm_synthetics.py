...
def main() -> None:
    ...
    parser.add_argument("--one-d-dir", default="WORK/DSM/1D_tele_syn/explosion/OUTPUT_FILES/disp_solid_time_sac")
    ...
    for pattern in ("L*_dep*_dist*.bh?", "*_dep*.bh?"):
        for path in out_1d.glob(pattern):
            path.unlink()
