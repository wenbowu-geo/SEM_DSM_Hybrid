...
#   generate_databases: ntasks=400, runs=2, range=00:00:06-00:00:08, avg=00:00:07.
#   mesh: ntasks=400, runs=2, range=00:00:04-00:00:05, avg=00:00:05.
...
echo "Estimated runtime from completed demo: mesh 00:00:04 with 400 CPU cores."
echo "Estimated runtime from completed demo: database generation 00:00:07 with 400 CPU cores."
