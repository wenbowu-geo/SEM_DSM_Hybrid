...
#   dsm_src_to_box: ntasks=256, runs=6, range=00:08:29-00:15:03, avg=00:10:52.
...
echo "Estimated runtime from completed demo: 00:08:43 with 256 CPU cores."
...
for source in "${SOURCES[@]}"; do
    ...
    echo "Submitting ${source} with ${CURRENT_NPROC} CPU cores."
