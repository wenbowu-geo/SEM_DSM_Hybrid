...
#   dsm_box_to_recv: ntasks=128, runs=1, runtime=00:05:12.
...
echo "Estimated runtime from completed demo: 00:04:35 with 128 CPU cores."
...
for force in "${FORCES[@]}"; do
    ...
    echo "Submitting ${force} with ${CURRENT_NPROC} CPU cores."
