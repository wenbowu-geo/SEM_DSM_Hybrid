...
echo "Running SEM solver for the 1-D 410-km topography example: $(date)"

# Path of the bin
dir_src="/user/wenbo.wu/SEM_DSM/SPECFEM3D/bin/"
...
echo "Solver job submitted with Job ID: $jobid_spec. Expected runtime: ~20 minutes."
