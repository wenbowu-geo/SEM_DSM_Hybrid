...
echo
echo "Extracting the injected DSM wavefield of the 410-km triplication example: `date`"
...
#SBATCH -J "410km_Inject"   # Job name
...
echo "        Wait for the SBATCH job to complete. It typically takes about 40 minutes with 262 processors."
