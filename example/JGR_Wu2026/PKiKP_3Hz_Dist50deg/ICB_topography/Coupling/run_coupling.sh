...
echo "#SBATCH --time=23:50:00   # Walltime" >> submit_coupling.cmd
echo "#SBATCH -J \"PKiKP_topo_coupling\"   # Job name" >> submit_coupling.cmd
...
# Final instructions
echo
echo "Waiting for the job to complete (~16 hours)."
