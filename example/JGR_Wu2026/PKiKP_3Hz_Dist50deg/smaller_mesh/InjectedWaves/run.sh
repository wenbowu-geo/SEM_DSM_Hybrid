...
echo
echo "Extracting the injected DSM wavefield of the PKiKP_1D_3Hz example: `date`"

###################################### Start: Specify Input Parameters ###################################
# Input and output directories:
dir_SEM="../SPECFEM3D/OUTPUT_FILES/DATABASES_MPI/"
#dir_DSM="../../../../DSM/example_clean_src/PKiKP_4Hz_Hydra/src_to_box/"
dir_DSM="../../DSM/src_to_box/"
dir_Injection_src="../../../../../src/SPECFEM3D/bin/"
...
echo "        Wait for the SBATCH job to complete. It typically takes about 11 minutes with 121 processors."
