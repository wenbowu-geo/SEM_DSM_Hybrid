...
echo "computing the Green's functions of the PKiKP_3Hz example : `date`"
...
setup_and_run_job "explosion" "25 1.0 1.0 1.0 0.0 0.0 0.0" "DSM_ICB_explosion" ${NPROC} "23:59:00"
