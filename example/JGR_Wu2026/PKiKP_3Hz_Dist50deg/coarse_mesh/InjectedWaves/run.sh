...
echo
echo "Extracting the injected DSM wavefield of the PKiKP_3Hz example: `date`"

###################################### Start: Specify Input Parameters ###################################
# Input and output directories:
dir_SEM="../SPECFEM3D/OUTPUT_FILES/DATABASES_MPI/"
dir_DSM="../../DSM/src_to_box/"
###../../../../DSM/example_clean_src/PKiKP_4Hz_Hydra/src_to_box/"
...
#SBATCH --mem-per-cpu=7G   # Memory per CPU core
...
echo "        Wait for the SBATCH job to complete. It typically takes about 30 minutes with 93 processors."
