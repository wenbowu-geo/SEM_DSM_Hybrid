...
modules="intel openmpi/intel/4.0.1"

# Source directory for coupling executable
#src="/vortexfs1/home/wenbo.wu/SEM_DSM/Coupling/src_new/"
src="../../src_largeNpackGroup_Poseidon/"
...
echo "#SBATCH --time=03:50:00   # Walltime" >> submit_coupling.cmd
