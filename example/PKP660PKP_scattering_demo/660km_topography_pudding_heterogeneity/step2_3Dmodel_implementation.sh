...
The 660 km topography and pudding heterogeneity are not applied:
  - Step 0 builds xgenerate_databases from model_tomo/1D_DSM
  - Step 1 writes MODEL=DSM1D and uses flat static layer interfaces
...
xgenerate_databases executable. After editing either source, rerun:
  ./step0_prepare_660km_heterogeneity.sh --install
