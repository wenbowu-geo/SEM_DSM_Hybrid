...
dx = dy = dz = 800.0  # Grid spacing in meters
Ly = 650e3 # Domain size (440 km)
Lx = 650e3  # Domain size
Lz = 1100e3  # Domain size (300 km)

correlation_scale = 8000.0  # Correlation scale in meters
rms = 0.04  # RMS value of perturbations
...
lat_center = 0.0
lon_center = 179.5
r_top = 6371000.0 - (660000.0 - 200000.0) # radius in meters
r_center = r_top - 200000.0  # Center radius
