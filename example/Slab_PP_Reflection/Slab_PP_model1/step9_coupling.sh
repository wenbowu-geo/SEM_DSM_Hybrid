...
# Runtime depends on the number of SEM packages, enabled components, and filesystem load.
# The generated Slurm log records the exact runtime and exit status.
...
NPROC=$(param COUPLING_NPROC 256)
